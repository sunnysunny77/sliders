...
openssl req -x509 -sha256 -days 356 -nodes -newkey rsa:2048  -subj '/CN=dev.localhost Root CA/C=AU/ST=Western Australia/L=Perth/O=Web Developers/OU=Dev' -keyout ca.key -out ca.crt
